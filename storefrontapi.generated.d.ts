...
export type ProductMixFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'title' | 'tags' | 'handle' | 'description' | 'vendor'
> & {
  seo: Pick<StorefrontAPI.Seo, 'description' | 'title'>;
  media: {
    nodes: Array<
...
export type ProductsWithImagesQuery = {
  products: {
    edges: Array<{
...
export type ProductQuery = {
  product?: StorefrontAPI.Maybe<
    ...
    > & {
      ...
      sweetness_level?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
...
export type MixAllProductsQueryVariables = StorefrontAPI.Exact<{
  count?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['Int']['input']>;
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  sortKey?: StorefrontAPI.InputMaybe<StorefrontAPI.ProductSortKeys>;
...
export type SectionProductDisplayFragment = Pick<
  StorefrontAPI.Metaobject,
  'type'
> & {
  title?: StorefrontAPI.Maybe<
...
interface GeneratedQueryTypes {
  '#graphql\n    query ProductsWithImages($first: Int!) {\n      products(first: $first) {\n        edges {\n          node {\n            handle\n            featuredImage {\n                  url\n            }\n          }\n        }\n      }\n    }\n': {
    return: ProductsWithImagesQuery;
    variables: ProductsWithImagesQueryVariables;
  };
